<template>
  <div>
    ...
    >
      ...
      <b-form class="form-modal-payment" @submit="sendData" v-if="show">
        <!-- usuario -->
        <b-form-group
          id="groupusers"
        ...
        >
          <date-picker
            ...
            :class="{ 'is-invalid': $v.form.end_date.$error }"
          />
          <template v-if="$v.form.end_date.$error">
            <div class="invalid-feedback" v-if="!$v.form.end_date.required">
              Digite la fecha de Pago
            </div>
          </template>
        </b-form-group>
        <b-form-group id="groupname" label="Valor a Pagar:" label-for="value">
          <b-form-input
            id="value"
            v-model="form.value"
...
export default {
  ...
  watch: {
    items() {
      ...
      this.form.end_date = this.items.end_date;
