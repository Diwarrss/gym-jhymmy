            ...
            <div class="col-lg-5 col-md-7">
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent">
                        <div class="text-muted text-center mt-2"><strong>{{ __('Inicio de Sesión') }}</strong></div>
                        ...
                        <form role="form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" placeholder="{{ __('Password') }}" type="password" value="123456789" required>
                                </div>
                    ...
                    <div class="col-6">
                        @if (Route::has('password.request'))
                            {{-- <a href="{{ route('password.request') }}" class="text-light">
                                <small>{{ __('Olvide contraseña') }}</small>
                            </a> --}}
                        @endif
                    </div>
